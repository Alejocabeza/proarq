...
__decorate([
    ...
    __metadata("design:type", String)
], Branch.prototype, "dni", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.branches, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => address_entity_1.Address, (address) => address.branch, {
        onDelete: 'SET NULL',
        onUpdate: 'CASCADE',
        eager: true,
    }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => project_entity_1.Project, (project) => project.branch),
    __metadata("design:type", Array)
], Branch.prototype, "projects", void 0);
__decorate([
