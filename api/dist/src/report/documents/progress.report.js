...
function getDaysSinceProjectStart(startDate) {
    const today = new Date();
    const timeDifference = today.getTime() - startDate.getTime();
    const daysDifference = Math.ceil(timeDifference / (1000 * 3600 * 24));
    return daysDifference;
}
function getDaysAdditionalProjectStart(endDate) {
    const today = new Date();
...
const progressReport = (project) => {
    ...
    const client = project.client
        ...
        : project.branch
            ...
            : null;
    return {
        defaultStyle: Object.assign(Object.assign({}, styles), { fontSize: 12 }),
        footer: [
            {
                ...
                columns: [
                    {
                        text: [
                            ...
                            {
                                text: (client === null || client === void 0 ? void 0 : client.name) + '\n',
                            },
                            {
                                text: (client === null || client === void 0 ? void 0 : client.email) + '\n',
                            },
                            {
                                text: (client === null || client === void 0 ? void 0 : client.dni) + '\n',
                            },
                            {
                                text: (client === null || client === void 0 ? void 0 : client.phone) + '\n',
                            },
                            {
                                text: (client === null || client === void 0 ? void 0 : client.address)
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            { text: 'Plazo Acordado:' },
                            {
                                text: getDateDifferenceInDays(new Date(project.startDate), new Date(project.endDate)) + ' Dias',
                            },
                        ],
                        [
                            { text: 'Total, Días Transcurridos:' },
                            {
                                text: getDaysSinceProjectStart(new Date(project.startDate)) > 0
                        ...
                        [
                            ...
                            {
                                text: getDaysAdditionalProjectStart(new Date(project.endDate)) +
                                    ' días',
                            },
                        ],
                        [
...
//# sourceMappingURL=progress.report.js.map