...
import { contingencyExpensesSchema } from "@app/schemas/contingency-expenses.schema";
import { useCreateContingencyExpensesMutation } from "@app/services/contingency-expenses.service";
...
const Page = () => {
  ...
  const [createData, { isLoading }] = useCreateContingencyExpensesMutation();
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    resolver: zodResolver(contingencyExpensesSchema),
  });
